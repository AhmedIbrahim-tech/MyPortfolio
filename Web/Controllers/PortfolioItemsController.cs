...
namespace Web.Controllers
{
    public class PortfolioItemsController : Controller
    {
        ...
        {
            return View(_portfolio.Entity.Find());
        }
        ...
        public IActionResult Details(Guid? id)
        {
            ...
            var portfolioItem = _portfolio.Entity.Details(id);
        ...
        public IActionResult Edit(Guid id, PortfolioViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    _portfolio.Entity.Edit(portfolioItem);
                    _portfolio.Save();
                }
        ...
        {
            return _portfolio.Entity.Find().Any(e => e.Id == id);
        }
    }
}